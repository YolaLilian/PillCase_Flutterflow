...
import '../compartment4/compartment4_widget.dart';
...
class Compartment3Widget extends StatefulWidget {
  const Compartment3Widget({Key key}) : super(key: key);

  @override
  _Compartment3WidgetState createState() => _Compartment3WidgetState();
}

class _Compartment3WidgetState extends State<Compartment3Widget> {
  DateTime datePicked;
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      ...
                      await Navigator.pushAndRemoveUntil(
                        context,
                        MaterialPageRoute(
                          builder: (context) => Compartment4Widget(),
                        ),
                        (r) => false,
                      );
                    },
