...
class Compartment5Widget extends StatefulWidget {
  const Compartment5Widget({Key key}) : super(key: key);

  @override
  _Compartment5WidgetState createState() => _Compartment5WidgetState();
}

class _Compartment5WidgetState extends State<Compartment5Widget> {
  DateTime datePicked;
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      ...
                      await Navigator.pushAndRemoveUntil(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              NavBarPage(initialPage: 'Compartments'),
                        ),
                        (r) => false,
                      );
                    },
