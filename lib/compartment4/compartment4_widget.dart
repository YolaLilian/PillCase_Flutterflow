...
import '../compartment5/compartment5_widget.dart';
...
class Compartment4Widget extends StatefulWidget {
  const Compartment4Widget({Key key}) : super(key: key);

  @override
  _Compartment4WidgetState createState() => _Compartment4WidgetState();
}

class _Compartment4WidgetState extends State<Compartment4Widget> {
  DateTime datePicked;
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      ...
                      await Navigator.pushAndRemoveUntil(
                        context,
                        MaterialPageRoute(
                          builder: (context) => Compartment5Widget(),
                        ),
                        (r) => false,
                      );
                    },
